<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminPaymentEdit.aspx.cs" Inherits="B2B.AdminPaymentEdit" %>
        ...
        <section class=" mb-5">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="input-group align-items-center" style="height: 52px">
                            <label for="status">Ordine nr: </label>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="input-group align-items-center">
                            <label for="status">Paypal ConfermID: </label>
