<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="EmployeeLogin.aspx.cs" Inherits="B2B.EmployeeLogin" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 text-center mx-auto">
                        <div class="hero-section-text">
                            ...
                            <img src="https://gestionale.bnbhosts.it/Content/Images/Logo_BNB_HOSTS_staff.png" style="max-width: 100%;" height="200" >
                            ...
                            <form class="custom-form hero-form" id="form1" runat="server" autocomplete="off">
                                ...
                                <div class="row">
                                    <asp:Button ID="LogInBtn" runat="server" Text="Entra" OnClick="LogInBtn_Click" CssClass="btn btn-success btn-lg" />
                                </div>

                                <asp:ValidationSummary ID="ValSummary" runat="server" CssClass="mt-lg-3 mb-lg-2 text-left text-white" ClientIDMode="Static" />
                                <asp:RequiredFieldValidator ID="ReqValName" runat="server" ErrorMessage="Please enter your name." CssClass="text-white" ControlToValidate="TxtName" Display="None"></asp:RequiredFieldValidator>
                                <asp:RequiredFieldValidator ID="ReqValPassword" runat="server" ErrorMessage="Please enter your password." CssClass="text-white" ControlToValidate="TxtPassword" Display="None"></asp:RequiredFieldValidator>
                                <asp:CustomValidator ID="ServerValidator" runat="server" ErrorMessage="Il nome o il numero non sono corretti." Display="None"></asp:CustomValidator>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-12 mb-3">
                    ...
                    <p class="text-white mb-1">
                        ...
                        <a href="tel: 090-080-0760" class="text-white">(+39)-081523154
                        </a>
                        <a href="tel: 090-080-0760" class="text-white">(+39)-355225266
                        </a>
                    </p>
