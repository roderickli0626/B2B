<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminEmployeeEdit.aspx.cs" Inherits="B2B.AdminEmployeeEdit" %>
    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-8 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4" runat="server" id="pageTitle">COLLABORATORI (nuovo)</h2>
            </header>
            <div class="container">
                ...
                <div class="row m-xs">
                    ...
                    <asp:RequiredFieldValidator ID="ReqValName" runat="server" ErrorMessage="Si prega di inserire il Nome" ControlToValidate="TxtName" Display="None" Enabled="true"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="ReqValMobile" runat="server" ErrorMessage="Si prega di inserire il numero di Cellulare." ControlToValidate="TxtMobile" Display="None" Enabled="true"></asp:RequiredFieldValidator>
                ...
                <div class="row text-right">
                    ...
                    <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/AdminEmployee.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                </div>
            </div>
        </section>
    </form>
