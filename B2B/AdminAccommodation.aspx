<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminAccommodation.aspx.cs" Inherits="B2B.AdminAccommodation" %>
    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-10 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4">SISTEMAZIONI</h2>
            </header>
            <div class="container">
                <div>
                    <div class="row">
                    ...
                    <table class="table table-bordered table-striped text-center" id="accommodation-table">
                        <thead>
                            <tr>
                                <th>Sistemazione</th>
                                <th>Descrizione</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="AdminFooterPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            var datatable = $('#accommodation-table').dataTable({
                "serverSide": true,
                "ajax": 'DataService.asmx/FindAccommodations',
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        return '<image src="' + ((data == "" || data == null) ? "Content/Images/accommodation_default.jpg" : "Upload/Accommodation/" + data) + '" style="height: 100px;width:100px;" />';
                    }
                }, {
                    "data": "Description",
                    "render": function (data, type, row, meta) {
                    ...
                    "data": null,
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminAccommodationEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }], 
            ...
            datatable.on('click', '.btn-delete', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'DataService.asmx/AdminDeleteAccommodation',
                    data: {
                        id: row.Id
                    },
                    success: function () {
