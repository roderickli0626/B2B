<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminRoom.aspx.cs" Inherits="B2B.AdminRoom" %>
    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-10 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4">ROOM</h2>
            </header>
            <div class="container">
                <div class="row">
        ...
        $(function () {
            var datatable = $('#room-table').dataTable({
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        switch (data) {
                            case 1: return "<p class='text-primary mb-0'>Inserita</p>"; break;
                            case 2: return "<p class='text-success mb-0'>Verificata</p>"; break;
                            case 3: return "<p class='text-danger mb-0'>Rifiutata</p>"; break;
                        }
                    }
                }, {
                    "data": "PriceListGroup",
                    ...
                    "data": null,
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminRoomEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }],
            ...
            datatable.on('click', '.btn-delete', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'DataService.asmx/AdminDeleteRoom',
                    data: {
                        id: row.Id
                    },
                    success: function () {
