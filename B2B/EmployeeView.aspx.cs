...
namespace B2B
{
    public partial class EmployeeView : System.Web.UI.Page
    {
        ...
        private Hashtable Getholiday(DateTime? startDate, DateTime? endDate, string searchKey, int status)
        {
            ...
            {
                holiday[order.StartDate?.ToString("M/d/yyyy")] += "<a class='d-block' " + " href='EmployeeViewEdit.aspx?id=" + order.Id + "&employeeID=" + employeeID + "'>" + "Ordine " + order.Id + "(" + order.EndDate?.ToString("dd/MM/yyyy") + ")</a>";
                holiday[order.StartDate?.ToString("d/M/yyyy")] += "<a class='d-block' " + " href='EmployeeViewEdit.aspx?id=" + order.Id + "&employeeID=" + employeeID + "'>" + "Ordine " + order.Id + "(" + order.EndDate?.ToString("dd/MM/yyyy") + ")</a>";
                holiday[order.StartDate?.ToString("dd/MM/yyyy")] += "<a class='d-block' " + " href='EmployeeViewEdit.aspx?id=" + order.Id + "&employeeID=" + employeeID + "'>" + "Ordine " + order.Id + "(" + order.EndDate?.ToString("dd/MM/yyyy") + ")</a>";
                holiday[order.StartDate?.ToString("MM/dd/yyyy")] += "<a class='d-block' " + " href='EmployeeViewEdit.aspx?id=" + order.Id + "&employeeID=" + employeeID + "'>" + "Ordine " + order.Id + "(" + order.EndDate?.ToString("dd/MM/yyyy") + ")</a>";
            }
