                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-8">
                        ...
                        <div class="row text-right">
                            ...
                            <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/AdminAccommodation.aspx" CssClass="btn btn-lg btn-secondary col-2 ms-3 me-3" />
                        </div>
                    </div>
                </div>
            </div>
