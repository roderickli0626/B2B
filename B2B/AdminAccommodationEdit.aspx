<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminAccommodationEdit.aspx.cs" Inherits="B2B.AdminAccommodationEdit" %>
    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-8 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4" runat="server" id="pageTitle">SISTEMAZIONI (nuova)</h2>
            </header>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="row text-right">
                            ...
                            <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/AdminAccommodation.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                        </div>
                    </div>
                </div>
            </div>
