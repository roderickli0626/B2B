<%@ Page Title="" Language="C#" MasterPageFile="~/StaffPage.master" AutoEventWireup="true" CodeBehind="StaffAccessoryEdit.aspx.cs" Inherits="B2B.StaffAccessoryEdit" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="row text-right">
                            ...
                            <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/StaffAccessory.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                        </div>
                    </div>
                </div>
            </div>
