<%@ Page Title="" Language="C#" MasterPageFile="~/StaffPage.master" AutoEventWireup="true" CodeBehind="StaffAccommodation.aspx.cs" Inherits="B2B.StaffAccommodataion" %>
        ...
        $(function () {
            var datatable = $('#accommodation-table').dataTable({
                ...
                "columns": [{
                    ...
                    "data": null,
                    "render": function (data, type, row, meta) {
                        return '<a href="StaffAccommodationEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }], 
