<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="B2B.ForgotPassword" %>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-8 text-center mx-auto">
                        <div class="hero-section-text">
                            ...
                            <h1 class="hero-title text-white mt-2 mb-4">Recupero Password</h1>
                            ...
                            <form class="custom-form hero-form" id="form1" runat="server" autocomplete="off">
                                ...
                                <div class="row">
                                    <asp:Button ID="SendEmail" runat="server" Text="Invia Email" OnClick="SendEmail_Click" CssClass="btn btn-success btn-lg" />
                                </div>

                                <asp:ValidationSummary ID="ValSummary" runat="server" CssClass="mt-lg-3 mb-lg-2 text-left text-white" ClientIDMode="Static" />
                                <asp:RequiredFieldValidator ID="ReqValEmail" runat="server" ErrorMessage="Inserisci la tua email." CssClass="text-white" ControlToValidate="TxtEmail" Display="None"></asp:RequiredFieldValidator>
        ...
        <div class="container">
            ...
            <div class="row mt-5 pt-lg-5">
                <div class="col-lg-5 col-md-5 col-12 mb-3">
                    ...
                    <p class="text-white">Partita Iva: 03252541101</p>
                </div>
