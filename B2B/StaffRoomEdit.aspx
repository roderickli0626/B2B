        ...
        <section class=" mb-5">
            ...
            <div class="container">
                ...
                <div class="row m-xs">
                    ...
                    <asp:RequiredFieldValidator ID="ReqValAddress" runat="server" ErrorMessage="Please enter Address." ControlToValidate="TxtAddress" Display="None" Enabled="True"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="ReqValStairCases" runat="server" ErrorMessage="Please enter StairCases." ControlToValidate="TxtStairCases" Display="None" Enabled="True"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="ReqValFloor" runat="server" ErrorMessage="Please enter Floor." ControlToValidate="TxtFloor" Display="None" Enabled="True"></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="ServerValidator1" runat="server" ErrorMessage="Save Failed." Display="None"></asp:CustomValidator>
                    <asp:CustomValidator ID="ServerValidator2" runat="server" ErrorMessage="Please Select Accessories." Display="None"></asp:CustomValidator>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group align-items-center">
                            ...
                            <asp:RadioButton ID="RadioButton1" runat="server" CssClass="form-control radio-custom text-primary" Text="..Inserita.." GroupName="StatusOption" Value="1" Checked="true" />
                            <asp:RadioButton ID="RadioButton2" runat="server" CssClass="form-control radio-custom text-success" Text="..Verificata.." GroupName="StatusOption" Value="2" />
                            <asp:RadioButton ID="RadioButton3" runat="server" CssClass="form-control radio-custom text-danger" Text="..Rifiutata.." GroupName="StatusOption" Value="3" />
                        </div>
                    </div>
                </div>
                <div class="row">
