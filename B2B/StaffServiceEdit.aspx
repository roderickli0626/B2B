        ...
        <section class=" mb-5">
            ...
            <div class="container">
                ...
                <div class="row m-xs">
                    ...
                    <asp:RequiredFieldValidator ID="ReqValTitle" runat="server" ErrorMessage="Inserire il titolo." ControlToValidate="TxtTitle" Display="None" Enabled="True"></asp:RequiredFieldValidator>
                ...
                <div class="row text-right">
                    ...
                    <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/StaffService.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                </div>
            </div>
        </section>
    </form>
