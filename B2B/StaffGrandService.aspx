    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-10 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4">CATEGORIA SERVIZI</h2>
            </header>
            <div class="container">
                <div>
                    <div class="row">
            ...
            var datatable = $('#grandService-table').dataTable({
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="StaffGrandServiceEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }],
