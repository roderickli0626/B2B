<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminEmployee.aspx.cs" Inherits="B2B.AdminEmployee" %>
    ...
    <script type="text/javascript">
        $(function () {
            var datatable = $('#employee-table').dataTable({
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminEmployeeEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }],
            ...
            datatable.on('click', '.btn-delete', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'DataService.asmx/AdminDeleteEmployee',
                    data: {
                        id: row.Id
                    },
                    success: function () {
