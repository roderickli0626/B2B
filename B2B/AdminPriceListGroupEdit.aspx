<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminPriceListGroupEdit.aspx.cs" Inherits="B2B.AdminPriceListGroupEdit" %>
        ...
        <section class=" mb-5">
            ...
            <div class="container">
                ...
                <div class="row m-xs">
                    ...
                    <asp:RequiredFieldValidator ID="ReqValDescription1" runat="server" ErrorMessage="Si prega inserire la percentuale." ControlToValidate="TxtPercent" Display="None" Enabled="True"></asp:RequiredFieldValidator>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="row text-right">
                            ...
                            <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/AdminPriceListGroup.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                        </div>
                    </div>
                </div>
            </div>
