<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminHostEdit.aspx.cs" Inherits="B2B.AdminHostEdit" %>
        ...
        <section class=" mb-5">
            ...
            <div class="container">
                ...
                <div class="row m-xs">
                    ...
                    <asp:RequiredFieldValidator ID="ReqValEmail" runat="server" ErrorMessage="Si prega inserire un indirizzo E-Mail." ControlToValidate="TxtHostEmail" Display="None" Enabled="true"></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="PasswordValidator1" runat="server" ErrorMessage="Si prega inserire una password." Display="None"></asp:CustomValidator>
                    ...
                    <asp:CustomValidator ID="EmailValidator" runat="server" ErrorMessage="Email non corretta." Display="None"></asp:CustomValidator>
                    <asp:CustomValidator ID="ServerValidator" runat="server" ErrorMessage="Email già registrata." Display="None"></asp:CustomValidator>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="input-group align-items-center">
                            ...
                            <asp:TextBox ID="TxtHostEmail" runat="server" CssClass="form-control" TextMode="Email"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" runat="server" id="PasswordDiv">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group align-items-center">
                            ...
                            <asp:TextBox ID="TxtHostPassword" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-group align-items-center">
                            <label for="product-name">Ripeti PW</label>
                            <asp:TextBox ID="TxtHostRepeatPW" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row text-right">
                    ...
                    <asp:Button ID="BtnCancel" runat="server" Text="Annulla" CausesValidation="False" PostBackUrl="~/AdminHost.aspx" CssClass="btn btn-lg btn-secondary col-md-2 col-5 ms-3 me-3" />
                </div>
            </div>
        </section>
    </form>
...
<asp:Content ID="Content3" ContentPlaceHolderID="AdminFooterPlaceHolder" runat="server">
    <script>
      $(document).ready(function() {
        ...
        function init() {
            setTimeout(function () {
                $('#TxtHostRepeatPW').attr('type', 'password');
                $('#TxtHostPassword').attr('type', 'password');
            }, 1000);
        }
