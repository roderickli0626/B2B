<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminGrandService.aspx.cs" Inherits="B2B.AdminGrandService" %>
    ...
    <form runat="server" id="from1" class="custom-form hero-form mx-auto mt-4 col-md-10 pb-lg-5">
        <section class=" mb-5">
            <header class="text-center">
                <h2 class="hero-title text-black-50 mt-3 mb-4">CATEGORIE SERVIZI</h2>
            </header>
            <div class="container">
                <div>
                    <div class="row">
    ...
    <script type="text/javascript">
        $(function () {
            var datatable = $('#grandService-table').dataTable({
                "serverSide": true,
                "ajax": 'DataService.asmx/FindGrandServices',
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminGrandServiceEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }], 
            ...
            datatable.on('click', '.btn-delete', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'DataService.asmx/AdminDeleteGrandService',
                    data: {
                        id: row.Id
                    },
                    success: function () {
