<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.master" AutoEventWireup="true" CodeBehind="AdminHost.aspx.cs" Inherits="B2B.AdminHost" %>
                ...
                <div>
                    <div class="row">
                        <div style="float: left; position: relative; z-index: 1;" class="col-lg-3 col-md-3 col-12 mb-2">
                            ...
                            <i class="fa fa-plus mr-sm"></i> Agg. Cliente
                            </asp:LinkButton>
                        </div>
            ...
            var datatable = $('#host-table').dataTable({
                ...
                "columns": [{
                    ...
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminHostEdit.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }],
